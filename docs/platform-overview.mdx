...
You can search and preview results showing basic info — free in the Generect app, \$0.002 per result through the API. You only pay the full price when you decide to **reveal** full contact details, including email or phone.

- **Preview**: free in the app, \$0.002 per result via the API (Name, Company, Title)
- **Reveal**: Paid (Verified Email, Phone, Full Profile, Social Links)
