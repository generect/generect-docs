...
Our [Data Processing Agreement](https://generect.com/dpa) applies to customers processing personal data through the API or the app. It is accepted with our Terms of Service, so there is nothing to sign — send the link straight to your legal or security team.

If your procurement needs a **countersigned copy**, or you have any data-protection question, write to [dpa@generect.com](mailto:dpa@generect.com).
