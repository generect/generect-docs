...
A DPA is available for customers processing personal data through the API or the app, including a countersigned copy where your procurement requires one — request it at [dpa@generect.com](mailto:dpa@generect.com).

Send any other data-protection question to the same address.
