---
title: Local MCP (npx)
description: "Quick guide to use Generect MCP with local installation"
---
...
The local MCP server runs on your machine via `npx generect-ultimate-mcp` and talks to the Generect API at `https://api.generect.com`. (The hosted remote MCP server lives at `https://mcp.generect.com/mcp` — see [Remote MCP](remote-mcp).) The configuration on different clients has some minor differences.
...
<img
  src="/media/claude-developer-settings2.png"
  alt="claude-developer-settings"
...
<a href="cursor://anysphere.cursor-deeplink/mcp/install?name=generect&config=eyJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsImdlbmVyZWN0LXVsdGltYXRlLW1jcEBsYXRlc3QiXSwiZW52Ijp7IkdFTkVSRUNUX0FQSV9CQVNFIjoiaHR0cHM6Ly9hcGkuZ2VuZXJlY3QuY29tIiwiR0VORVJFQ1RfQVBJX0tFWSI6IlRva2VuIDxhcGkta2V5PiIsIkdFTkVSRUNUX1RJTUVPVVRfTVMiOiI2MDAwMCJ9fQ%3D%3D" target="_blank">
<img
