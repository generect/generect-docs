...
Preview API returns masked cached lead data, such as name, title, company, location, industry, and seniority, with a unique lead ID. Users browse results and pay only when they reveal full profiles or contact data.
